...
exports.ActiveLinkScheduler = void 0;
const types_1 = require("../types");
class ActiveLinkScheduler {
    ctx;
    service;
    tasks = new Map();
    ...
    listenToCancelEvents() {
        this.ctx.on('activelink/task-cancelled', (taskId) => {
    ...
    async start() {
        ...
        this.ctx.on('activelink/task-created', (task) => {
...
exports.ActiveLinkScheduler = ActiveLinkScheduler;
